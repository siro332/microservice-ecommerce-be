...
public class ProductInventoryClientImpl {
    ...
    public Optional<List<ProductInventory>> getProductInventoryByProductCode(String productCode)
    {
    ...
    Optional<List<ProductInventory>> getDefaultProductInventoryByCode(Exception e) {
